 ...
 * @version $Id: frites.php 2019-07-20 19:59:16Z webchills $
 */
...
$zco_notifier->notify('NOTIFY_CHECKOUT_PROCESS_AFTER_SEND_ORDER_EMAIL');
	...
	public function install() {
		...
		$this->check_frites_fields();
    $db->Execute('insert into ' . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('Version', 'MODULE_PAYMENT_FRITES_MODULE_VERSION', '2.2.4', 'Version installed:', '6', 0, NOW(), NOW(), NULL, 'zen_cfg_read_only(');");
