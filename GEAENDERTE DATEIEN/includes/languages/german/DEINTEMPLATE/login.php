 ...
 * @version $Id: login.php for Amazon Pay 2019-07-20 19:05:14Z webchills $
 */
...
define('HEADING_AMAZON_CUSTOMER_SPLIT', 'Login und Bezahlen mit Amazon');
define('TEXT_AMAZON_CUSTOMER_SPLIT', 'Express Checkout mit Amazon: Bei der Anmeldung mit Amazon über den Amazon Button werden Ihre bei Amazon hinterlegten Kontaktdaten für ein Kundenkonto in unserem Onlineshop genutzt. Sie müssen Ihre Daten nicht eintippen und für die Zahlung werden Ihre bei Amazon hinterlegten Zahlungsarten angeboten.<br/>Bitte beachten Sie dass Amazon Gutscheine mit dieser Zahlungsart NICHT möglich sind.');
